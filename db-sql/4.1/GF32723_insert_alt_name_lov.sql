...
--Insert into DESIGNATION_TYPES_LOV (DESCRIPTION,DETL_NAME,COMMENTS,CREATED_BY,DATE_CREATED,DATE_MODIFIED,MODIFIED_BY) values ('GO','Gene Ontology',null,'SBR',to_date('08-MAY-03','DD-MON-RR'),to_date('23-OCT-06','DD-MON-RR'),'DWARZEL');
--Insert into DESIGNATION_TYPES_LOV (DESCRIPTION,DETL_NAME,COMMENTS,CREATED_BY,DATE_CREATED,DATE_MODIFIED,MODIFIED_BY) values ('ICD-10_','ICD-10',null,'SBR',to_date('08-MAY-03','DD-MON-RR'),to_date('23-OCT-06','DD-MON-RR'),'DWARZEL');
--Insert into DESIGNATION_TYPES_LOV (DESCRIPTION,DETL_NAME,COMMENTS,CREATED_BY,DATE_CREATED,DATE_MODIFIED,MODIFIED_BY) values ('RadLex','Radiology Lexicon',null,'SBR',to_date('08-MAY-03','DD-MON-RR'),to_date('23-OCT-06','DD-MON-RR'),'DWARZEL');
--Insert into DESIGNATION_TYPES_LOV (DESCRIPTION,DETL_NAME,COMMENTS,CREATED_BY,DATE_CREATED,DATE_MODIFIED,MODIFIED_BY) values ('MGED','The MGED Ontology',null,'SBR',to_date('08-MAY-03','DD-MON-RR'),to_date('23-OCT-06','DD-MON-RR'),'DWARZEL');
--Insert into DESIGNATION_TYPES_LOV (DESCRIPTION,DETL_NAME,COMMENTS,CREATED_BY,DATE_CREATED,DATE_MODIFIED,MODIFIED_BY) values ('Zebrafish','Zebrafish',null,'SBR',to_date('08-MAY-03','DD-MON-RR'),to_date('23-OCT-06','DD-MON-RR'),'DWARZEL');
