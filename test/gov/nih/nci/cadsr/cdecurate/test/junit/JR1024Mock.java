...
/**
 * *****************************************************************************************************************
 * NOTES: DO NOT FORGET TO CALL replay(), this is EasyMock, which is not really that easy unfortunately!!!
 * *****************************************************************************************************************
 */
public class JR1024Mock extends EasyMockAdapter {
...
//	public HttpServletRequest getM_classReq() {
//		return m_classReq;
//	}
...
//		m_classReq = createNiceMock(HttpServletRequest.class);
