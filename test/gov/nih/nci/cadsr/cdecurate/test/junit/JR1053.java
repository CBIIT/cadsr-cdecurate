...
public class JR1053 {
	...
	public void testPositive() {
		...
		try {
			...
			java.util.List<String> checkList = Arrays.asList("Data Element RAI", "Object Class Concept RAI", "Property Concept RAI", "Value Domain Concept RAI", "Representation Concept RAI");
			int count = 0;
