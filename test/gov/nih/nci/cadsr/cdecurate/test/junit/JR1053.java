...
public class JR1053 {
	...
	public void testPositive() {
		...
		try {
			...
			java.util.List<String> checkList = Arrays.asList("Data Element RAI", "Object Class Concept NCI RAI", "Property Concept NCI RAI", "Value Domain Concept NCI RAI", "Representation Concept NCI RAI");
			int count = 0;
