...
public class GetACSearch implements Serializable
{
        ...
        try
        {
            ...
            if( sKeyword != null )
            {
                ...
                if( sSearchIn.equals( "minID" ) )
                {
                    ...
                    else if( sSearchAC.equals( "ConceptualDomain" ) )
                    {
                        doCDSearch( "", "", "", sContext, sVersion, sStatus, sCreatedFrom, sCreatedTo, sModifiedFrom,
                                sModifiedTo, sCreator, sModifier, sMinID, "", dVersion, "", "", "", vAC, sRecordsDisplayed );
                    }
                    else if( sSearchAC.equals( "ValueMeaning" ) )
                    {
                        ...
                        do_caDSRSearch( "", sContext, sStatus, sMinID, vAC, "OC", "", "", sRecordsDisplayed );
                    else if( sSearchAC.equals( "Property" ) )
                        do_caDSRSearch( "", sContext, sStatus, sMinID, vAC, "PROP", "", "", sRecordsDisplayed );
                    else if( sSearchAC.equals( "ConceptClass" ) )
                        vAC = do_ConceptSearch( "", "", sContext, sStatus, sMinID, "", "", vAC, sRecordsDisplayed );
                }
                ...
                else if( sSearchIn.equals( "origin" ) )
                {
                    ...
                    {
                        doCDSearch( "", "", "", sContext, sVersion, sStatus, sCreatedFrom, sCreatedTo, sModifiedFrom,
                                sModifiedTo, sCreator, sModifier, "", sOrigin, dVersion, "", "", "", vAC, sRecordsDisplayed );
                    }
                }
                ...
                else if( sSearchIn.equals( "concept" ) )
                {
                    ...
                    {
                        doCDSearch( "", "", "", sContext, sVersion, sStatus, sCreatedFrom, sCreatedTo, sModifiedFrom,
                                sModifiedTo, sCreator, sModifier, "", "", dVersion, sCon, "", "", vAC, sRecordsDisplayed );
                    }
                    ...
                    else if( sSearchAC.equals( "ValueMeaning" ) )
                    {
                        ...
                        do_caDSRSearch( "", sContext, sStatus, "", vAC, "OC", sCon, "", sRecordsDisplayed );
                    else if( sSearchAC.equals( "Property" ) )
                        do_caDSRSearch( "", sContext, sStatus, "", vAC, "PROP", sCon, "", sRecordsDisplayed );
                ...
                else
                {
                    ...
                    {
                        do_caDSRSearch( sKeyword, sContext, sStatus, "", vAC, "OC", "", "", sRecordsDisplayed );
                    }
                    else if( sSearchAC.equals( "Property" ) )
                    {
                        do_caDSRSearch( sKeyword, sContext, sStatus, "", vAC, "PROP", "", "", sRecordsDisplayed );
                    }
                    else if( sSearchAC.equals( "ConceptualDomain" ) )
                    {
     ...
     * @throws Exception
     */
    private void pushAllOntoStack(
            Stack sSearchACStack, Stack vACSearchStack, Stack vSelRowsStack,
     ...
     * @throws Exception
     */
    public void stackSearchComponents(
            String sSearchAC, Vector vAC, Vector vRSel, Vector vSearchID, Vector vSearchName,
     ...
     * @param vList         returns Vector of DEbean.
     */
    public void doDESearch(
            String DE_IDSEQ, String InString, String ContID, String ContName, String ContUse,
            ...
            else
            {
                ...
                if( rs != null )
                {
                    ...
                    while( rs.next() && g < recordsDisplayed )
                    {
                        ...
                        {
                            String testString = rs.getString( "de_idseq" );
                            if( recordMap.containsKey( testString ) )
                            {
                                isFound = true;
                            }
                        }
     ...
     */
    //===added regStatus parameter for GF32398
    public void doDECSearch(
            String DEC_IDSEQ, String InString, String ContID, String ContName, String sVersion,
            ...
            else
            {
                ...
                if( rs != null )
                {
                    ...
                    while( rs.next() && g < recordsDisplayed )
                    {
                        ...
                        DECBean.setDEC_PREFERRED_NAME(StringUtil.escapeHtmlEncodedValue(rs.getString( "preferred_name" ) ));
                        DECBean.setDEC_LONG_NAME(StringUtil.escapeHtmlEncodedValue(AdministeredItemUtil.handleLongName( rs.getString( "long_name" ) ) )); //GF32004
                        DECBean.setDEC_PREFERRED_DEFINITION(StringUtil.escapeHtmlEncodedValue(rs.getString( "preferred_definition" ) ));
                        ...
                        DECBean.setDEC_CHANGE_NOTE(StringUtil.escapeHtmlEncodedValue(rs.getString( "change_note" ) ));
...
//            SQLHelper.closeConnection(m_servlet.getConn());		//GF32438
    ...
    public void doVDSearch(
            String VD_IDSEQ, String InString, String ContID, String ContName, String sVersion,
...
//                        VDBean.setVD_LONG_NAME(rs.getString("long_name"));
                        ...
                        VDBean.setVD_CHANGE_NOTE(StringUtil.escapeHtmlEncodedValue( rs.getString( "change_note" ) ));
...
//            SQLHelper.closeConnection(m_servlet.getConn());		//GF32438
     ...
     */
    public Vector doCDSearch(
            String CD_IDSEQ, String InString, String ContID, String ContName, String sVersion,
    ...
    public String getStatusValues(
            HttpServletRequest req, HttpServletResponse res, String sSearchAC, String sAction,
    ...
    public Vector addMultiRecordConDomain( String cdName, String acName, Vector<String> vRes ) throws Exception
    {
        ...
        if( cdName != null && !cdName.equals( "" ) )
        {
            ...
            cdList = this.doCDSearch( "", "", "", "", "", "", "", "", "", "", "", "", "", "", 0, "", "", acName, cdList, "0" ); // get
            // the
            // list
            // of
            // Conceptual
     ...
     * @throws java.lang.Exception
     */
    private Vector addMultiRecordConcept(
            String conName, String acName, String acIDseq, String ac2IDseq, String acType,
     ...
     */
    public void do_caDSRSearch(
            String InString, String ContName, String ASLName, String ID, Vector<EVS_Bean> vList,
            String type, String conName, String conID, String sRecordsDisplayed )
    {
        ResultSet rs = null;
        CallableStatement cstmt = null;
        String sCUIString = "";
     ...
     * @param vList    returns Vector of DEC bean.
     */
    public Vector<EVS_Bean> do_ConceptSearch(
            String InString, String conIdseq, String ContName, String ASLName,
            String conID, String decID, String vdID, Vector<EVS_Bean> vList, String sRecordsDisplayed )
    {
        // Connection conn = null;
        ResultSet rs = null;
        CallableStatement cstmt = null;
        try
        {
            ...
            if( rs != null )
            {
                ...
                while( rs.next() && g < recordsDisplayed )
                {
                    ...
                    logger.debug( "At line 4149 of GetACSearch.do_ConceptSearch sVocab:" + sVocab + ", menuAction:" + menuAction );
                    ...
                    conBean.setCONCEPT_IDENTIFIER( StringUtil.escapeHtmlEncodedValue(sPref ));
                    ...
                    logger.debug( "At line 4069 of GetACSearch.do_ConceptSearch " + conBean.getCONCEPT_NAME() + "**" + conBean.getLONG_NAME() + "**" + conBean.getCONTEXT_NAME() + "**" + conBean.getCONCEPT_IDENTIFIER() + "**" + conBean.getPREFERRED_DEFINITION() );
                    if( isExist == false )
     ...
     * @throws Exception
     */
    private void storeOldAttInSession(
            HttpServletRequest req, HttpServletResponse res, DE_Bean DEBean,
     ...
     */
    private boolean doSelectDEforQuestion(
            HttpServletRequest req, HttpServletResponse res, Quest_Bean QuestBean,
...
*/
     ...
     */
    public void refreshDesData(
            String desCompID, String desContext, String desContextID, String action, String deAlt,
            String deRD )
    {
        HttpSession session = m_classReq.getSession();
        Vector vSRows = new Vector();
    ...
    public void refreshData(
            HttpServletRequest req, HttpServletResponse res, DE_Bean m_DE, DEC_Bean m_DEC,
    ...
    public void getACSearchForCreate( HttpServletRequest req, HttpServletResponse res, boolean isIntSearch )
    {
        ...
        try
        {
            ...
            logger.debug( ">>>>>>>>> getACSearchForCreate Constants.USER_SELECTED_VOCAB [" + session.getAttribute( Constants.USER_SELECTED_VOCAB ) + "] saved." );
            if( dtsVocab != null && !dtsVocab.equals( "" ) )
                isBlockSearch = true;
            if( dtsVocab == null )
                dtsVocab = "";
            ...
            else if( sSearchAC.equals( "EVSValueMeaning" ) || sSearchAC.equals( "VMConcept" ) || sSearchAC.equals( "EditVMConcept" ) )
            {
                ...
                if( sSearchIn.equals( "publicID" ) )
                    vAC = do_ConceptSearch( "", "", sContext, sStatus, sKeyword, "", "", vAC, sRecordsDisplayed );
            ...
            else if( sSearchAC.equals( "ObjectClass" ) )
            {
                ...
                if( sSearchIn.equals( "publicID" ) )
                {
                    do_caDSRSearch( "", sContext, sStatus, sKeyword, vAC, "OC", "", "", sRecordsDisplayed );
                    vAC = do_ConceptSearch( "", "", sContext, sStatus, sKeyword, "", "", vAC, sRecordsDisplayed );
                }
                else if( !sSearchIn.equals( "Code" ) || !sSearchInEVS.equals( "MetaCode" ) )
                {
            ...
            else if( sSearchAC.equals( "Property" ) )
            {
                ...
                if( sSearchIn.equals( "publicID" ) )
                {
                    do_caDSRSearch( "", sContext, sStatus, sKeyword, vAC, "PROP", "", "", sRecordsDisplayed );
                    vAC = do_ConceptSearch( "", "", sContext, sStatus, sKeyword, "", "", vAC, sRecordsDisplayed );
                }
                else if( !sSearchIn.equals( "Code" ) || !sSearchInEVS.equals( "MetaCode" ) )
                {
            ...
            else if( sSearchAC.equals( "RepTerm" ) )
            {
                ...
                else
                {
                    if( sSearchIn.equals( "publicID" ) )
                    {
                        do_caDSRSearch( "", sContext, sStatus, sKeyword, vAC, "REP", "", "", sRecordsDisplayed );
                        vAC = do_ConceptSearch( "", "", sContext, sStatus, sKeyword, "", "", vAC, sRecordsDisplayed );
                    }
                    else if( !sSearchIn.equals( "Code" ) || !sSearchInEVS.equals( "MetaCode" ) )
                    {
                        do_caDSRSearch( sKeyword, sContext, sStatus, "", vAC, "REP", "", "", sRecordsDisplayed );
                        vAC = do_ConceptSearch( sKeyword, "", sContext, sStatus, "", "", "", vAC, sRecordsDisplayed );
                    }
                    // To search Synonym in EVS, need to filter
                    sKeyword = ( String ) session.getAttribute( "creKeyword" );
...
//            SQLHelper.closeConnection(m_servlet.getConn());		//GF32438
    ...
    public void do_nonEVSRepTermSearch(
            String InString, String ContName, String ASLName, String ID, Vector<EVS_Bean> vList,
