	...
	public int doEndTag() throws JspException{
		...
		try {
			NCIFooter.println("<div class=\"xyz\">"
							...
							+ "onclick=\"window.open('https://cbiit.nci.nih.gov/about/contact-us', '_blank');\">"
							+ "CONTACT US"
							+ "</span><span CLASS=\"footerItemSep\">|</span><span CLASS=\"footerItemNormal\""
							+ "onmouseover=\"this.className = 'footerItemFocus';\""
							+ "onmouseout=\"this.className = 'footerItemNormal';\""
							+ "onclick=\"window.open('https://www.nih.gov/about/privacy.htm', '_blank');\">"
							+ "PRIVACY NOTICE"
							+ "</span><span CLASS=\"footerItemSep\">|</span><span CLASS=\"footerItemNormal\""
							+ "onmouseover=\"this.className = 'footerItemFocus';\""
							+ "onmouseout=\"this.className = 'footerItemNormal';\""
							+ "onclick=\"window.open('https://www.nih.gov/about/disclaim.htm', '_blank');\">"
							+ "DISCLAIMER"
							+ "</span><span CLASS=\"footerItemSep\">|</span><span CLASS=\"footerItemNormal\""
							+ "onmouseover=\"this.className = 'footerItemFocus';\""
							+ "onmouseout=\"this.className = 'footerItemNormal';\""
							...
							+ "onmouseover=\"this.className = 'footerItemFocus';\""
							+ "onmouseout=\"this.className = 'footerItemNormal';\""
							+ "onclick=\"window.open('https://www.hhs.gov/vulnerability-disclosure-policy/index.html', '_blank');\">"
			                ...
			                +"<a href=\"https://www.dhhs.gov/\"  target=\"_blank\"><img src=\""+ request.getContextPath() +"/images/footer_hhs.gif\"  width=\"39\" height=\"31\" alt=\"Department of Health and Human Services\"  border=\"0\"/></a>"
			                +"<a href=\"https://www.nih.gov/\" target=\"_blank\"><img src=\""+ request.getContextPath() +"/images/footer_nih.gif\"   width=\"46\" height=\"31\" alt=\"National Institutes of Health\"  border=\"0\"/></a>"
			                +"<a href=\"https://www.firstgov.gov/\"  target=\"_blank\"><img  src=\""+ request.getContextPath() +"/images/footer_firstgov.gif\" width=\"91\" height=\"31\" alt=\"FirstGov.gov\" border=\"0\"/></a>"
			                +"</div></div>");
		} catch (IOException e) {
			e.printStackTrace();
		}
