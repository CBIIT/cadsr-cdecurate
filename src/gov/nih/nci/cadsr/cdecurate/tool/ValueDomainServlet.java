...
public class ValueDomainServlet extends CurationServlet
{
    ...
    private void doEditVDActions() throws Exception
    {
        ...
        {
            GetACSearch serAC = new GetACSearch( m_classReq, m_classRes, this );
            String sField = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( ( String ) m_classReq.getParameter( "pvSortColumn" ) );
            VD_Bean vd = ( VD_Bean ) session.getAttribute( "m_VD" );
    ...
    private void doChangeVDNameType() throws Exception
    {
        ...
        if( ( m_classReq.getParameter( "txtPreferredName" ) != null ) && ( !StringUtil.isHtmlAndScriptClean( ( String ) m_classReq.getParameter( "txtPreferredName" ) ) ) )
        {
        ...
        String sNameType = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( ( String ) m_classReq.getParameter( "rNameConv" ) );
        ...
        String sPrefName = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( ( String ) m_classReq.getParameter( "txtPreferredName" ) );
...
//					}
    ...
    public AC_Bean getSystemName( AC_Bean ac, Vector<EVS_Bean> vParent )
    {
        ...
        try
        {
            ...
            String selNameType = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( ( String ) m_classReq.getParameter( "rNameConv" ) );
            ...
            else
            {
                ...
                String sPrefName = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( ( String ) m_classReq.getParameter( "txPreferredName" ) );
    ...
    private void doRemoveParent( String sPVAction, String vdPage ) throws Exception
    {
        ...
        String sParentCC = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( ( String ) m_classReq.getParameter( "selectedParentConceptCode" ) );
        String sParentName = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( ( String ) m_classReq.getParameter( "selectedParentConceptName" ) );
        String sParentDB = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( ( String ) m_classReq.getParameter( "selectedParentConceptDB" ) );
...
//				m_VD.setVD_REP_TERM(sLongName);
     ...
     * @param nameAct string new name or append name
    ...
    public AC_Bean getACNames( EVS_Bean newBean, String nameAct, AC_Bean pageAC )
    {
        ...
        {
            selNameType = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( ( String ) m_classReq.getParameter( "rNameConv" ) );
            sPrefName = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( ( String ) m_classReq.getParameter( "txPreferredName" ) );
            if( selNameType != null && selNameType.equals( "USER" ) && sPrefName != null )
    ...
    private void doVDUseSelection( String nameAction )
    {
        try
        {
            ...
            EVS_Bean m_REP = new EVS_Bean();
            String sComp = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( ( String ) m_classReq.getParameter( "sCompBlocks" ) );
            ...
            if( sComp.equals( "RepTerm" ) || sComp.equals( "RepQualifier" ) )
            {
                sSelRow = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( ( String ) m_classReq.getParameter( "selRepRow" ) );
                ...
                if( sSelRow != null && !sSelRow.equals( "" ) )
                {
                    ...
                    // get name value pari
                    String sNVP = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( ( String ) m_classReq.getParameter( "nvpConcept" ) );
            ...
            {//Rep Term or from vocabulary
                if( m_REP.getcaDSR_COMPONENT() != null && !selectedRepQualifiers )
                {//if selected existing rep term
     ...
     *
     * @param nameAction String naming action
     * @param vdBean     selected DEC_Bean
     * @param eBean      selected EVS_Bean
     * @param repType    String property type (primary or qualifier)
     * @return DEC_Bean
     * @throws Exception
     */
    @SuppressWarnings( "unchecked" )
    private VD_Bean addRepConcepts(
            String nameAction, VD_Bean vdBean,
    ...
    private void doInsertVD() throws Exception
    {
        ...
        if( sVDEditAction == null )
            sVDEditAction = "";
        String sAction = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( ( String ) m_classReq.getParameter( "ValidateVDPageAction" ) );
        // String sMenuAction = (String) session.getAttribute(Session_Data.SESSION_MENU_ACTION);
        // String sButtonPressed = (String) session.getAttribute("LastMenuButtonPressed");
        String sOriginAction = ( String ) session.getAttribute( "originAction" );
        if( sAction == null )
...
//			VDBeanSR.setVD_REP_TERM(sRepTerm);
     ...
     *
     * @param VDBeanSR dec attribute bean.
     * @throws Exception
     */
    ...
    private void doRemoveBuildingBlocksVD() throws Exception
    {
        ...
        {
            sSelRow = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( ( String ) m_classReq.getParameter( "selRepQRow" ) );
            if( sSelRow != null && !( sSelRow.equals( "" ) ) )
            {
    ...
    public void doOpenViewPage() throws Exception
    {
        ...
        if( acID.equals( "" ) )
            acID = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( m_classReq.getParameter( "idseq" ) );
    ...
    {
        String tab = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( m_classReq.getParameter( "vdpvstab" ) );
        String from = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( m_classReq.getParameter( "from" ) );
        String id = /* app scan fix */ StringUtil.cleanJavascriptAndHtml( m_classReq.getParameter( "id" ) );
