...
public class VMServlet extends GenericServlet
{
     ...
     * @param ser CurationServlet pointer
     */
    ...
    public void readDataForSearch( GetACSearch getac, String sRecordsDisplayed )
    {
        ...
        if( (("Search".equals(actType)) && (!("searchForCreate".equals(menuAction)))) ||  //CURATNTOOL-1284 this is a value "Search" received on Search VM operation CURATNTOOL-1285 different attribute list for searchForCreate
    ...
    private void captureUserEntered( String sAction )
    {
        try
        {
            if( !sAction.equals( VMForm.ACT_BACK_PV ) && !sAction.equals( VMForm.ACT_SUBMIT_VM ) && !sAction.equals( VMForm.ACT_BACK_SEARCH ) )
            {
                ...
                // CURATNTOOL-1107
                if( ( sWorkflow != null ) && ( !StringUtil.isHtmlAndScriptClean( sWorkflow ) ) )
                {
