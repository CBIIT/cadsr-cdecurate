...
public class FormBuilderUtil {
	...
	public static final void createPVValidValue(Connection conn, Quest_Bean questBean, PV_Bean pvBean) throws Exception {
	...
	public static final void createQuestionRelationWithPV(Connection conn, int displayOrder, Quest_Bean questBean, PV_Bean pvBean) throws Exception {
		if(conn == null) throw new Exception("Database connection is null or empty!");
	...
	public static final void createQuestion(Connection conn, int displayOrder, Quest_Bean questBean, String QCid, String VPid) throws Exception {
		if(conn == null) throw new Exception("Database connection is null or empty!");
		...
		newQuestionSQL += "'" + uniqueId + "',";	//QC_IDSEQ e.g. 14B849C8-9711-24F5-E050-BB89A7B41326
