...
//		m_classReq.getSession().setAttribute("arrayColumnTypes", arrayColumnTypes);
	...
	public static Workbook createWorkbook(String colString, String fillIn, ArrayList<String[]> downloadRows, ValueHolder vh, ArrayList<HashMap<String,ArrayList<String[]>>> arrayData) {
		List data = (ArrayList) vh.getValue();
