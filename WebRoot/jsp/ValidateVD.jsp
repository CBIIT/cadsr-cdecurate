 ...
 if (vValidate != null)
  {
    for (int i = 0; vValidate.size()>i; i = i+3)
    {
      ...
      String sContent = StringUtil.escapeHtmlEncodedValue(StringUtil.unescapeHtmlEncodedValue(StringUtil.cleanJavascriptAndHtml((String)vValidate.elementAt(i+1)))); 
