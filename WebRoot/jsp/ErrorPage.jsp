                    ...
                    <td colspan="2" align="center">
                       <form name="LoginForm" method="POST" action="../../cdecurate/NCICurationServlet?reqType=login">
                        ...
                        <table style="border-collapse: collapse"><col align="right"/><col />
                            <tr><td style="padding: 0.2in 0.1in 0.1in 0.1in"><b>User&nbsp;Name</b></td><td style="padding: 0.2in 0.1in 0.1in 0.1in"><input type="text" name="Username" value="" size="25" autocomplete="off" /></td></tr>
                            <tr><td style="padding: 0.1in 0.1in 0.1in 0.1in"><b>Password</b></td><td style="padding: 0.1in 0.1in 0.1in 0.1in"><input type="password" name="Password" value="" size="25" autocomplete="off" /></td></tr>
