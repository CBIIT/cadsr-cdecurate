<!-- Copyright (c) 2006 ScenPro, Inc.
    ...
    <%@ page import="gov.nih.nci.cadsr.cdecurate.tool.html.RendererUtil" %>     <!--JR665-->
...
String propCDR = "";
    ...
    //begin JR665
    String sRegStatus = m_DEC.getDEC_REG_STATUS();
...
%>
                <%=RendererUtil.toSelectOption(sReg, sRegStatus)%>     <!--JR665-->
<%
            }
        }
%>
